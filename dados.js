  // Array de objetos representando destinos turísticos brasileiros, com informações sobre estado, cidade, atração e descrição.
let dados = [
//#region Informações sobre o estado do Acre
  {
    estado: "Acre",
    cidade: "Rio Branco",
  ...
  //#endregion
//#region Informações sobre o estado de Alagoas
  {
    estado: "Alagoas",
    cidade: "Maceió",
  ...
  //#endregion
//#region Informações sobre o estado do Amapá
  {
    estado: "Amapá",
    cidade: "Macapá",
  ...
  //#endregion
//#region Informações sobre o estado do Amazonas
  {
    estado: "Amazonas",
    cidade: "Manaus",
  ...
  //#endregion
//#region Informações sobre o estado da Bahia
  {
    estado: "Bahia",
    cidade: "Salvador",
    atracao: "Pelourinho",
  ...
  //#endregion
//#region Informações sobre o estado do Ceará
  {
    estado: "Ceará",
    cidade: "Fortaleza",
  ...
  //#endregion
//#region Informações sobre o estado do Distrito Federal
  {
  ...
  //#endregion
//#region Informações sobre o estado do Espírito Santo
  {
  ...
  //#endregion
//#region Informações sobre o estado de Goiás
  {
    estado: "Goiás",
    cidade: "Pirenópolis",
    atracao: "Centro Histórico",
  ...
  //#endregion
//#region Informações sobre o estado do Maranhão
  {
    estado: "Maranhão",
    cidade: "São Luís",
    atracao: "Centro Histórico",
  ...
  //#endregion
//#region Informações sobre o estado do Mato Grosso
  {
    estado: "Mato Grosso",
    cidade: "Cuiabá",
  ...
  //#endregion
//#region Informações sobre o estado do Mato Grosso do Sul
  {
  ...
  //#endregion
//#region Informações sobre o estado de Minas Gerais
  {
    estado: "Minas Gerais",
    cidade: "Ouro Preto",
    atracao: "Centro Histórico",
  ...
  //#endregion
//#region Informações sobre o estado do Pará
  {
    estado: "Pará",
    cidade: "Belém",
  ...
  //#endregion
//#region Informações sobre o estado da Paraíba
  {
    estado: "Paraíba",
    cidade: "João Pessoa",
    atracao: "Centro Histórico",
  ...
  //#endregion
//#region Informações sobre o estado do Paraná
  {
    estado: "Paraná",
  ...
  //#endregion
//#region Informações sobre o estado de Pernambuco
  {
    estado: "Pernambuco",
    cidade: "Recife",
  ...
  //#endregion
//#region Informações sobre o estado do Piauí
  {
    estado: "Piauí",
  ...
  //#endregion
//#region Informações sobre o estado do Rio de Janeiro
  {
  ...
  //#endregion
//#region Informações sobre o estado do Rio Grande do Norte
  {
  ...
  //#endregion
//#region Informações sobre o estado do Rio Grande do Sul
  {
  ...
  //#endregion
//#region Informações sobre o estado de Rondônia
  {
    estado: "Rondônia",
    cidade: "Porto Velho",
  ...
  //#endregion
//#region Informações sobre o estado de Roraima
  {
    estado: "Roraima",
    cidade: "Boa Vista",
  ...
  //#endregion
//#region Informações sobre o estado de Santa Catarina
  {
  ...
  //#endregion
//#region Informações sobre o estado de São Paulo
  {
    estado: "São Paulo",
    cidade: "São Paulo",
  ...
  //#endregion
//#region Informações sobre o estado de Sergipe
  {
    estado: "Sergipe",
    cidade: "Aracaju",
  ...
  //#endregion
//#region Informações sobre o estado do Tocantins
  {
    estado: "Tocantins",
    cidade: "Jalapão",
    atracao: "Fervedouros",
